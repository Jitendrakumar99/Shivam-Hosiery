...
const Wishlist = () => {
  ...
  if (!isAuthenticated) {
    return (
      <div className="min-h-screen bg-page-bg pt-32 pb-12">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        {loading ? (
          ...
          <div className="bg-card-bg rounded-lg shadow-md p-12 text-center">
            ...
            <Link
              to="/products"
              className="inline-block bg-trana-primary text-white px-6 py-3 rounded-lg hover:bg-trana-dark transition"
            >
              Browse Products
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {items.map((item) => {
              ...
              if (!product) {
                return (
                  <div key={item._id} className="bg-card-bg rounded-lg shadow-md p-6 flex flex-col items-center justify-center border-2 border-dashed border-gray-200">
              ...
              return (
                <div key={item._id || product._id} className="bg-card-bg rounded-lg shadow-md overflow-hidden">
